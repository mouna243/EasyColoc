...
<body>
    <div class="container">
        ...
        <form action="{{ route('colocation.category.update', [$colocation, $category]) }}" method="Post" class="card">
            @csrf
            @method("PUT")
            <div class="card-header">
                <h2><span>➕</span> Update catégorie</h2>
            </div>
            <div class="form-row">
                <div class="form-group">
                    <label>Nom de la catégorie</label>
                    <input value="{{ $category->name }}" type="text" id="categoryName" name="name" class="form-control" placeholder="Ex: Courses, Loyer, Électricité...">
                </div>
