...
<body>
    <div class="container">
        ...
        <form action="{{ route('colocation.category.store', $colocation) }}" method="Post" class="card">
            @csrf
            <div class="card-header">
                <h2><span>➕</span> Nouvelle catégorie</h2>
            </div>
            <div class="form-row">
                <div class="form-group">
                    <label>Nom de la catégorie</label>
                    <input type="text" id="categoryName" name="name" class="form-control" placeholder="Ex: Courses, Loyer, Électricité...">
                </div>
        ...
        <div class="card">
            <div class="card-header">
                <h2><span>📋</span> Catégories de dépenses</h2>
            </div>
                ...
                @forelse ($categories as $category)
                    <div class="category-card" style="border-color: ${cat.color}">
                        <div class="category-header">
                            <div class="category-icon" style="background: linear-gradient(145deg, ${cat.color}, #9B59B6)">
                                🛒
                            </div>
                            <div class="category-name">{{ $category->name }}</div>
                        </div>
                        <div class="category-actions">
                            <a href="{{ route('colocation.category.edit', [$colocation, $category]) }}" class="btn btn-small btn-primary" >✏️</a>
                            <form action="{{ route("colocation.category.destroy", [$colocation, $category]) }}" method="POST">
                                @csrf
                                @method('DELETE')
